        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('disponibilite', 1, old('disponibilite', old('disponibilite')), ['required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('localisation_latitude', $place->localisation_latitude , ['id' => 'localisation-latitude']) !!}
                    {!! Form::hidden('localisation_longitude', $place->localisation_longitude , ['id' => 'localisation-longitude']) !!}
                    <p class="help-block"></p>
