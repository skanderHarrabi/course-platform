...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($categories) > 0 ? 'datatable' : '' }} @can('categorie_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        @can('categorie_delete')
                        ...
                        <th>@lang('quickadmin.categorie.fields.name')</th>
                        <th>@lang('quickadmin.categorie.fields.description')</th>
