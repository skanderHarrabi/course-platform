...
<nav class="learn-press-breadcrumb" ><a href="/">Home</a><i class="fa fa-caret-right" aria-hidden="true"></i>My Cources</nav>							</div>
						</div>
									</div>
                            ...
                            <ul class="learn-press-tabs tabs">
                                ...
                                <div id="profile-content-orders">
                                   ...
                                   <div class="panel panel-default">
                                       <div class="panel-body">
                                          <ul class="list-group">
                                              ...
                                              <li class="list-group-item">
                                                  <span class="badge">{{$item['price']}} DT</span>
                                                  {{$item['item']['title']}} |@if($item['qty']<2) {{$item['qty']}} place @else {{$item['qty']}} places @endif
                                              </li>
                                              @endforeach
                                          </ul>
                                       </div>
                                       ...
                                       <strong>Total Price: {{$order->cart->totalPrice}} DT</strong>
                                       </div>
                                   ...
                                   <article id="post-2190" class="post-2190 page type-page status-publish hentry">
                                    <div class="entry-content">
                                        <div class="woocommerce"><p class="cart-empty">Your dont order anything .</p>	<p class="return-to-shop">
