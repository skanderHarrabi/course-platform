                        ...
                        <div id="learn-press-profile-header" class="lp-profile-header">
                            <div class="lp-profile-cover">
                                <div class="lp-profile-avatar">
                                    <img src="{{$user->profile->avatar}}" width="96" height="96" alt="Adrian C. Wick" class="avatar avatar-96 wp-user-avatar wp-user-avatar-96 alignnone photo" />          
                        ...
                        <a id="profile-mobile-menu" class="fa fa-bars"></a>
                            <ul class="learn-press-tabs tabs">
                                    ...
                                    <li class="change-password">
                                                                <a href="{{route('pass')}}">Password</a>
                                    </li>
                                    <li class="my-discussion ">
                                            <a href="{{route('Mydiscussion')}}">My discussions</a>
                                 </li>
