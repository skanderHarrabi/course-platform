...
<!-- Mirrored from wp-education.xoothemes.com/profile/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Apr 2018 18:23:14 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
@include('includes.head')

<body class="page-template-default page page-id-8 wp-custom-logo profile wp-education learnpress learnpress-page tribe-no-js ep-page-layout-grid ep-has-page-title ep-no-page-sidebar ep-page-header-default wpb-js-composer js-comp-ver-5.4.7 vc_responsive">
...
<nav class="learn-press-breadcrumb" ><a href="../index.html">Home</a><i class="fa fa-caret-right" aria-hidden="true"></i>Profile</nav>							</div>
						</div>
									</div>
                        ...
                        <div id="learn-press-profile-header" class="lp-profile-header">
                            <div class="lp-profile-cover">
                                <div class="lp-profile-avatar">
                                    <img src="{{asset($user->profile->avatar)}}" width="96" height="96" alt="{{$user->name}}" class="avatar avatar-96 wp-user-avatar wp-user-avatar-96 alignnone photo" />          
                                      <h4 class="ep-user-display-name">{{$user->name}}</h4>
                        ...
                        <a id="profile-mobile-menu" class="fa fa-bars"></a>
                            <ul class="learn-press-tabs tabs">
                                    ...
                                    <li class="basic-information">
                                                                <a href="{{route('formateur.general')}}">General</a>
                                    </li>
                                  
                                    <li class="change-password">
                                                                <a href="{{route('formateur.pass')}}">Password</a>
                                    </li>
                                    <li class="change-password">
                                            <a href="{{route('formateur.calendar')}}">calender</a>
                </li>
                                ...
                                <div id="profile-content-orders">
			
			
                                        <div class="profile-orders">
                                        
                                            
                                        <h3 class="profile-heading">Cource To Teach</h3>
                                        
                                        <table class="lp-list-table profile-list-orders profile-list-table table table-bordered">
                                        
                                            <thead>
                                            <tr class="order-row">
                                                <th class="column-order-number">Cource</th>
                                                <th class="column-order-date">Start Date</th>
                                                <th class="column-order-total">Nomber of students</th>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr class="order-row">
                                                    <td class="column-order-number">{{$item['item']['title']}}</td>
                                                    <td class="column-order-date">{{$item['item']['date_debut_formation']}}</td>
                                                    <td class="column-order-status">      1 students   </td>
                                                </tr>
                                                 @endif
                                                     @endforeach
                                                     @endforeach
                                            ...
                                            <tr class="list-table-nav">
                                                <td colspan="2" class="nav-text">Displaying 1 to 4 of 4 items.</td>
                                                <td colspan="3" class="nav-pages"></td>
                                            </tr>
                                            </tfoot>
...
<script type='text/javascript'>
/* <![CDATA[ */
var lpGlobalSettings = {"url":"http:\/\/wp-education.xoothemes.com\/profile\/","siteurl":"http:\/\/wp-education.xoothemes.com","ajax":"http:\/\/wp-education.xoothemes.com\/wp-admin\/admin-ajax.php","theme":"wp-education"};
/* ]]> */
</script>
<script type='text/javascript'>
/* <![CDATA[ */
...
<!-- Mirrored from wp-education.xoothemes.com/profile/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Apr 2018 18:23:23 GMT -->
</html>