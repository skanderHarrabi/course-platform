...
<nav class="learn-press-breadcrumb" ><a href="/">Home</a><i class="fa fa-caret-right" aria-hidden="true"></i>password</nav>							</div>
						</div>
									</div>
		...
		<div class="learnpress">
                ...
                <div id="learn-press-user-profile" class="lp-user-profile guest">
                        ...
                        <ul class="lp-tab-sections">
                                ...
                                <li class="section-tab basic-information">
                                                    <a href="{{route('formateur.general')}}">General</a>
                                            </li>
                        
                            
                                <li class="section-tab change-password active">
                                                    <span>Password</span>
                                            </li>
                        ...
                        <form method="post" action="{{route('auth.change_password')}}" name="profile-change-password" enctype="multipart/form-data" class="learn-press-form">
                            ...
                            <ul class="form-fields">
                                ...
                                <li class="form-field">
                                    ...
                                    <div class="form-field-input">
                                        ...
                                        <p id="lp-password-not-match" class="description lp-field-error-message hide-if-js">New password does not match!</p>
                                    </div>
                                </li>
