		...
		<div class="learnpress">
                ...
                <div id="learn-press-user-profile" class="lp-user-profile guest">
                        ...
                        <ul class="lp-tab-sections">
                                ...
                                <li class="section-tab basic-information active">
                                                    <span>General</span>
                                            </li>
                            
                                <li class="section-tab change-password">
                                                    <a href="{{route('formateur.pass')}}">Password</a>
                                            </li>
                        ...
                        <form method="post" action="{{route('profile.update')}}" enctype="multipart/form-data" class="learn-press-form">
                        
                            {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                            {!! Form::label('name', trans('quickadmin.users.fields.name').'*', ['class' => 'control-label','placeholder' =>'{{$user->name}}']) !!}
                                             <input name="name" id="name" cols="1" rows="1" class="form-control"value="{{$user->name}}">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                            ...
                                            <input name="email" id="email" cols="1" rows="1" class="form-control"value=" {{$user->email}}">
                                            <p class="help-block"></p>
                                            @if($errors->has('email'))
                                                <p class="help-block">
                                                    {{ $errors->first('email') }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <input name="facebook" id="facebook" cols="1" rows="1" class="form-control"value="{{$user->profile->facebook}}" >
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                            ...
                                            <input name="linkedin" id="linkedin" cols="1" rows="1" class="form-control"value="{{$user->profile->linkedin}}">
