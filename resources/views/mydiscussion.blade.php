                ...
                <div id="learn-press-user-profile" class="lp-user-profile guest">
                        ...
                        <div id="learn-press-profile-content" class="lp-profile-content">
                           ...
                           <article id="post-2190" class="post-2190 page type-page status-publish hentry">
                                <div class="entry-content">
                                    <div class="woocommerce"><p class="cart-empty">Your create any discussions .</p>	<p class="return-to-shop">
                                    <a class="button wc-backward" href="{{route('message')}} ">
                                        Create new discussion		</a>
                                </p>
                            </div>
                                </div><!-- .entry-content -->
