	...
	<a class="skip-link screen-reader-text" href="#content">Skip to content</a>
			...
			@include('includes.header') <!-- #masthead -->
					...
					<div class="educationpress-page-title">
						<div class="container">
							<h1 class="entry-title">All discussions</h1>
						</div>
					</div>
...
<article id="post-9" class="post-9 page type-page status-publish hentry">
        ...
        <div class="panel panel-default">
                <div class="panel-heading ">
                   <img src="{{asset($d->user->profile->avatar)}}" alt="" width="40px" height="40px">&nbsp;&nbsp;&nbsp;
            ...
            <div class="text-center"><h3p><strong>Comments<hr></strong></h3></div>
             @foreach($d->replies as $r)
            
             <div class="panel panel-default">
                    <div class="panel-heading ">
                       <img src="{{asset($r->user->profile->avatar)}}" alt="" width="40px" height="40px">&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="panel-footer">
                       ...
                       @if($r->is_liked_by_auth_user())
                         <a href="{{route('replay.unlike',['id'=>$r->id])}}" class="btn btn-danger btn-xs">Unlike <span class="badge">{{$r->likes->count()}} </span></a>
                       @else
                       <a href="{{route('replay.like',['id'=>$r->id])}}" class="btn btn-success btn-xs">Like <span class="badge">{{$r->likes->count()}} </span></a>
                       @endif
             ...
             <div class="panel panel-default">
                 <div class="panel-body">
                     <form action="{{route('discussion.replay',['id'=>$d->id])}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                         <button type="submit" class="btn btn btn-primary pull-right">leave a reply</button>
                     </div>
                    </form>
                 </div>
             </div>
