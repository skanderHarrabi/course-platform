...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: Formation
        Gate::define('formation_access', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('formation_create', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('formation_edit', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('formation_view', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('formation_delete', function ($user) {
            return in_array($user->role_id, [1]);
        });
        ...
        // Auth gates for: Place
        Gate::define('place_access', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('place_create', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('place_edit', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('place_view', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('place_delete', function ($user) {
            return in_array($user->role_id, [1]);
        });
